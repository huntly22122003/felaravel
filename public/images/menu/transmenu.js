...
TransMenu.backgroundPng = "nutmenu2.gif";          // a PNG graphic to server as the background for mac IE5
...
function TransMenu(oActuator, iDirection, iLeft, iTop, iReferencePoint, parentMenuSet) {
        ...
        function toString() {
                ...
                return '<div id="' + id + '" class="' + sClassName + '">' + 
                        ...
                        '<tr><td><img src="' + TransMenu.spacerGif + '" width="1" height="' + TransMenu.menuPadding + '"></td></tr>' + 
                        aHtml.join('') + '</table>' + 
